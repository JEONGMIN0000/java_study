...
//		System.out.println(jpy.getClass().getName());
	}
}
...
class Currency{
	...
	public String toString() {
		return String.format(" %s : %.2f %s", "환전할 돈", this.amount, this.notation);
	}
...
class KRW extends Currency{
	...
	public String toString() {
		return String.format(" %s : %.2f %s", "KRW", this.amount, this.notation);
	}
}
...
class USD extends Currency{
	...
	public String toString() {
		return String.format(" %s : %.2f %s", "USD", this.amount, this.notation);
	}
}
...
class EUR extends Currency{
	...
	public String toString() {
		return String.format(" %s : %.2f %s", "EUR", this.amount, this.notation);
	}
}
...
class JPY extends Currency{
	...
	public String toString() {
		return String.format(" %s : %.2f %s", "JPY", this.amount, this.notation);
	}
}